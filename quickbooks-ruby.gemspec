# -*- encoding: utf-8 -*-
# stub: quickbooks-ruby 0.0.6 ruby lib

Gem::Specification.new do |s|
  s.name = "quickbooks-ruby"
  s.version = "0.0.6"
  ...
  s.date = "2014-02-19"
  s.description = "REST API to Quickbooks Online via Intuit Data Services v3"
  ...
  s.homepage = "http://github.com/ruckus/quickbooks-ruby"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.2.1"
  s.summary = "REST API to Quickbooks Online via Intuit Data Services v3"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<guard-rspec>, ["= 3.0.0"])
    else
      ...
      s.add_dependency(%q<guard-rspec>, ["= 3.0.0"])
    end
  else
    s.add_dependency(%q<oauth>, [">= 0"])
    s.add_dependency(%q<roxml>, [">= 0"])
